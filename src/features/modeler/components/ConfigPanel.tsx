import type { BoardConfiguration, TailShape, FinConfiguration } from '../../../types/surfboard'
    ...
    <div className="bg-white/90 backdrop-blur-sm p-6 rounded-lg shadow-lg space-y-6 overflow-y-auto h-full">
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => updateDimension('noseWidth', parseFloat(e.target.value))}
              className="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer accent-purple-600"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => updateDimension('tailWidth', parseFloat(e.target.value))}
              className="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer accent-purple-600"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => updateDimension('noseRocker', parseFloat(e.target.value))}
              className="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer accent-purple-600"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => updateDimension('tailRocker', parseFloat(e.target.value))}
              className="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer accent-purple-600"
            />
          </div>
        </div>
      ...
      <section>
        ...
        <div className="grid grid-cols-3 gap-2">
          {(['squash', 'round', 'pin', 'swallow', 'diamond', 'square'] as TailShape[]).map((shape) => (
            <button
              key={shape}
      ...
      <section>
        ...
        <div className="grid grid-cols-2 gap-2">
          {(['single', 'twin', 'thruster', 'quad', 'five-fin'] as FinConfiguration[]).map((fin) => (
            <button
              key={fin}
